...
class CommonCell extends Component {
     constructor(props){
	  ...
	  render() {
			return (
					<TouchableOpacity style={styles.container} onPress={()=>{Util._jumpFocus(this.props.navigator,this.props.component)}}>
	  ...
	  rightTitle(){
			if(this.props.rightTitle&&this.props.rightTitle.length>0){
				  return(
						  <Text style={{marginRight:2,fontSize:12,color:'#b2b2b2',fontFamily:"黑体"}}>{this.props.rightTitle}</Text>
				  )
			}
	  }
}
