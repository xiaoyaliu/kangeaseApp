	  ...
	  render() {
			return (
					<View style={styles.container}>
						  <Nav title="修改姓名" navigator={this.props.navigator}/>
						  <View style={styles.main}>
								<View style={styles.ViewItem}>
									  <TextInput style={styles.styleRight}  onChangeText ={(value)=>this.changeValue(value)} value={this.state.name} underlineColorAndroid='transparent'placeholder="请输入姓名" placeholderTextColor="#b2b2b2"/>
								</View>
